...
impl JiraDatabase {
    ...
    pub fn create_story(&self, story: Story, epic_id: u32) -> Result<u32> {
        ...
        db.epics.get_mut(&epic_id)
                .ok_or_else(|| anyhow!("Invalid epic id {epic_id}"))?
                .stories.push(db.last_item_id);
    ...
    pub fn delete_epic(&self, epic_id: u32) -> Result<()> {
        ...
        db.epics.remove(&epic_id)
                .ok_or_else(|| anyhow!("Invalid epic id {epic_id}"))?
                .stories.iter()        
                        .for_each(|id| {db.stories.remove(id);});
    ...
    pub fn delete_story(&self,epic_id: u32, story_id: u32) -> Result<()> {
        ...
        epic.stories.iter()
                    ...
                    .map(|idx| epic.stories.remove(idx))
                    .ok_or_else(|| anyhow!("Invalid story id {story_id}"))?;
